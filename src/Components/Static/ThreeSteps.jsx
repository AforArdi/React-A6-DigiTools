            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-4'>
                ...
                <div className="card bg-base-100 w-96 shadow-sm">
                    ...
                    <div className="card-body flex flex-col justify-center items-center">
                        ...
                        <h2 className="card-title font-extrabold">Create Account</h2>
                ...
                <div className="card bg-base-100 w-96 shadow-sm">
                    <div className='w-full flex justify-end pt-5 pr-5'>
                        <p className="badge badge-primary rounded-full">2</p>
                    </div>
                    <div className="card-body flex flex-col justify-center items-center">
                        <div className='w-10 bg-[#62738225] rounded-full p-2'>
                            <img src={PackageIcon} alt="" />
                        </div>
                        <h2 className="card-title font-extrabold">Choose Products</h2>
                ...
                <div className="card bg-base-100 w-96 shadow-sm">
                    <div className='w-full flex justify-end pt-5 pr-5'>
                        <p className="badge badge-primary rounded-full">3</p>
                    </div>
                    <div className="card-body flex flex-col justify-center items-center">
                        <div className='w-10 bg-[#62738225] rounded-full p-2'>
                            <img src={RocketIcon} alt="" />
                        </div>
                        <h2 className="card-title font-extrabold">Start Creating</h2>
